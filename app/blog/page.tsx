...
// DİKKAT: Next.js 16/15+ için params Promise olarak tip tanımlanmalı ve await edilmelidir.
// Aksi takdirde slug undefined gelir ve 404 hatası alırsınız.
export default async function BlogPost({ params }: { params: Promise<{ slug: string }> }) {
  // Params'ı await ile bekliyoruz
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 text-center p-6">
        ...
        <div className="bg-red-50 text-red-600 p-4 rounded-lg mb-6 text-sm">
           Hata Kodu: SLUG_NOT_FOUND (Aranan: {slug})
        </div>
