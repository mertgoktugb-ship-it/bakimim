...
// 4 KLASÖR GERİ ÇIKAN DOĞRU YOL (TÜM BAKIMLAR SAYFASI İÇİN)
...
export default function ModelDetaySayfasi() {
  ...
  // BU SAYFA TÜM BAKIMLARI GÖSTERİR 
  const aktifKategori: string = "tumu";
    ...
    try {
      ...
      if (data) {
        const filtrelenmis = data.map(item => ({
          ...
          // TÜMÜ sayfası olduğu için kategori filtresi koymuyoruz, sadece marka/model eşleşmesi yeterli
