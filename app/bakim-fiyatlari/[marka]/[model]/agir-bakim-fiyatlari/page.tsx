...
export default function AltKategoriDetaySayfasi() {
  ...
  if (yukleniyor) {
    return <div className="min-h-screen flex items-center justify-center font-black text-yellow-500 uppercase italic animate-pulse">VERİLER SENKRONİZE EDİLİYOR...</div>;
  }
